...
export default function SearchBar() {
  const filterByname = useCeunsusStore (state => state.filterByname)
    ...
    return (
      <div>
        <div className=" dark:border-white dark:text-black rounded-md flex w-full items-center border border-2 border-black p-2">
          {/* <svg className="text-gray-400 mr-3" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <input onChange={handleChange}type="text" className="p-2 flex-grow bg-white dark:bg-dark_white focus:outline-none" placeholder="Qué calle?"></input>
        </div>
